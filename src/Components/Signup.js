    ...
    <div className='flex'>
      ...
      <h1 className='font-bold text-primary text-xl lg:text-3xl leading-[45px] pt-5 pb-6 justify-center'>Welcome To IRent</h1>
        <div className='text-left flex flex-col'>
                ...
                <input type='email' placeholder='Confirm password' className='w-full py-[3vh]  pl-[1.5vw] lg:pl-[3vh] h-[5vh] mb-4 rounded-[10px] shadow [1px 4px 54px 13px rgba(0, 0, 0, 0.08)] bg-white' />
                </div>
